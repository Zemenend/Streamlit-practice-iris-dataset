...
page = st.sidebar.selectbox("Select Page",["Home","Dataset Overview","Exploratory Data Analysis (EDA)","Extras"])
...
# Data Overview 
    ...
    st.write("""The Iris dataset is one of the most famous datasets in the literature of machine learning and data analysis.
    ...
    # Dataset display
    st.subheader("Quick glance at the Dataset")
...
# Exploratory Data Analysis (EDA)
    ...
    st.subheader("Select the type of visualization you would like to explore")
...
if page == "Extras":
    ...
    col1,col2,col3 = st.columns(3)  ## Creates 3 equal width columns across the page
    ...
    st.divider()     # used to separate different parts of the content
    ...
    with tab1:
        st.write("Please whatever you want here! This is the first tab!")
